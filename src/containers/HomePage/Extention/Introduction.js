        ...
        return (
            <>
                ...
                <div className='container mb-3'>
                    <div className='extra-infor mt-4 '>
                    ...
                    <div className='extra-infor'>Hướng dẫn sử dụng dịch vụ:
                        <ul>
                            <li>
                                Người dùng có thể sử dụng dịch vụ của Homecare trên Website: <a target='_.blank' rel="noreferrer" href="#" >www.Homecare.com</a> hay app Homecare trên điện thoại
                            </li>
                            <li>
                                Truy cập vào <a target='_.blank' ref='noreferrer' href='https://www.facebook.com/profile.php?id=61555318416572&open_field=website&sk=about_contact_and_basic_info'>Panfage</a>  hay Website để theo dõi vào được thông báo về những gói khám được ưu đãi từ chúng tôi
                            </li>
                        </ul>
